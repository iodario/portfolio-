            ...
            <div class="container">
                ...
                <div class="row my-sm-3 my-3">
                    ...
                    <div class="col-sm-6 col-12 px-2 my-2">
                        <div class="bg-white">
                            <img src="files/aJuego.png" alt="JsGame" class="img-fluid" width="200">
                            <div class="row p-3">
                                <div class="col-12">
                                    <h3>Js Game</h3>
                                </div>
                            ...
                            <div class="row px-3 py-3">
                                <div class="col-12">
                                    <p>Juego sencillo en Javascript, empleando funciones y EventListener</p>
                                </div>
                            </div>
                            <div class="row px-3 pt-4">
                                <div class="col-6">
                                    <a href="https://iodario.github.io/jsgame/" class="btn" target="_blank">Ver
                                        online</a>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="https://github.com/iodario/jsgame" target="_blank">Código fuente</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-12 px-2 my-2">
                        <div class="bg-white">
                            <img src="files/aabmventas.png" alt="ABM Ventas" class="img-fluid">
                            <div class="row p-3">
                                <div class="col-12">
                            ...
                            <div class="row pb-3 px-3">
                                <div class="col-6">
                                    <a href="#" class="btn" target="_blank">Ver
                                        online</a>
                                </div>
                                <div class="col-6 text-right">
                ...
                <div class="row">
                    <div class="col-sm-6 col-12 py-2 px-2">
                        <div class="bg-white">
                            <img src="files/asistema-admin.png" alt="ABM Ventas" class="img-fluid">
                            <div class="row p-3">
                                <div class="col-12">
